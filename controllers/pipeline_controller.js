...
const PipelineResource = require("../resources/pipeline_resource");
    ...
    .then(
      ([
        ...
        if (
          ...
          Helper.lead.pushToError(errors, 'meetings', "meeting person is invalid!");
        }
        ...
        Lead.findOneAndUpdate(
          ...
          .then(lead => {
            ...
            const result = new Promise((resolve, reject) => {
              ...
              return Helper.main.response200(res, new PipelineResource(lead));
            });
          })
          .catch(err => {
            console.log(err);
